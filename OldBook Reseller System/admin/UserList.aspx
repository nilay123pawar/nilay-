    ...
    <table style="width:100%;">
        <tr>
            ...
            <td bgcolor="#336699" align="left">
                <asp:Label ID="Label1" runat="server" Text="User List" Font-Size="Large" 
        ...
        <tr>
            <td style="height: 22px">
                <asp:Label ID="Label2" runat="server" Font-Bold="True" 
                    Text="Select Student Type"></asp:Label>
            </td>
            <td style="height: 22px">
                <asp:DropDownList ID="ddlType" runat="server" Height="16px" Width="103px" 
        ...
        <tr>
            <td style="height: 22px" colspan="2">
                ...
                <asp:SqlDataSource ID="SqlDataGetUser" runat="server" 
                    ...
                    SelectCommand="SELECT [UserID], [Pwd], [Name], [City], [Branch], [usertype], [PhotoFile] FROM [UserMaster]">
                </asp:SqlDataSource>
            </td>
        </tr>
        <tr>
